...
const openGeneratePersonalNameDialog = async (
  ...
  const nationalityOptions = ['Random Person', 'Random Pirate', 'Spanish', 'English', 'French', 'Dutch', 'Scottish', 'Irish', 'Welsh', 'Portuguese', 'Akan', 'Bantu', 'Fon', 'Igbo', 'Mandinka'].map(nation => {
